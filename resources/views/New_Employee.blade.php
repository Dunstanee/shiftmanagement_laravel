...
<div class="row">
    <div class="col-md-6">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Employee Registration</div>
        ...
        <div class="ibox">
            ...
            <div class="ibox-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" id="ex-phone" type="text" name="contact">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group" id="date_3">
                            <div class="input-group date">
                                ...
                                <input class="form-control" type="text" name="dob" value="{{date('Y-m-d')}}">
                            </div>
                        </div>
                    </div>
                </div>
